...
},{"hbsfy/runtime":56}],6:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
...
},{"hbsfy/runtime":56}],7:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
...
},{"hbsfy/runtime":56}],8:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":56}],9:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "node_modules\n";
...
},{"hbsfy/runtime":56}],10:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":56}],11:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":56}],12:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var stack1;
...
},{"hbsfy/runtime":56}],13:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":56}],14:[function(require,module,exports){
...
},{"../../lib/generator":35,"./helpers/dependencies":14,"./helpers/parameters-snippet":15,"./helpers/request-snippet":16,"./partials/auth.js.hbs":18,"./partials/client.js.hbs":19,"./partials/resources.js.hbs":20,"./partials/utils.js.hbs":21,"./templates/.gitignore.hbs":22,"./templates/INSTALL.md.hbs":23,"./templates/README.md.hbs":24,"./templates/__init__.py.hbs":25,"./templates/index.js.hbs":26,"./templates/package.json.hbs":27,"./templates/raw.py.hbs":28,"camel-case":42,"javascript-stringify":60}],18:[function(require,module,exports){
arguments[4][5][0].apply(exports,arguments)
},{"dup":5,"hbsfy/runtime":56}],19:[function(require,module,exports){
arguments[4][6][0].apply(exports,arguments)
},{"dup":6,"hbsfy/runtime":56}],20:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
},{"dup":7,"hbsfy/runtime":56}],21:[function(require,module,exports){
arguments[4][8][0].apply(exports,arguments)
},{"dup":8,"hbsfy/runtime":56}],22:[function(require,module,exports){
arguments[4][9][0].apply(exports,arguments)
},{"dup":9,"hbsfy/runtime":56}],23:[function(require,module,exports){
arguments[4][10][0].apply(exports,arguments)
},{"dup":10,"hbsfy/runtime":56}],24:[function(require,module,exports){
arguments[4][11][0].apply(exports,arguments)
},{"dup":11,"hbsfy/runtime":56}],25:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var alias1=this.escapeExpression;

  return "# Heres a python module\n\n\"\"\"\nheres some stuff for pydoc to chew on\n\"\"\"\n\nclass Thing:\n      def xx(_):\n      	  pass\n      pass\n\n"
    + alias1(this.lambda(depth0, depth0))
    + "\n\n"
    + alias1((helpers.stringify || (depth0 && depth0.stringify) || helpers.helperMissing).call(depth0,depth0,{"name":"stringify","hash":{},"data":data}))
    + "\n";
},"useData":true});

},{"hbsfy/runtime":56}],26:[function(require,module,exports){
arguments[4][12][0].apply(exports,arguments)
},{"dup":12,"hbsfy/runtime":56}],27:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
},{"dup":13,"hbsfy/runtime":56}],28:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "import json\n\nx=\"\"\"\n"
    + this.escapeExpression((helpers.stringify || (depth0 && depth0.stringify) || helpers.helperMissing).call(depth0,depth0,(depth0 != null ? depth0['null'] : depth0),4,{"name":"stringify","hash":{},"data":data}))
    + "\n\"\"\"\n\nx=x.replace('&#x27;','\"')\n\nprint x\n\n#json.loads(x)\n";
},"useData":true});

},{"hbsfy/runtime":56}],29:[function(require,module,exports){
...
},{"./parameters":31,"./resources":32,"./security":33,"./uri":34,"extend":48,"methods":62}],30:[function(require,module,exports){
...
},{"./parameters":31,"object.pick":63}],31:[function(require,module,exports){
var pick = require('object.pick');
...
},{"object.pick":63}],32:[function(require,module,exports){
var sanitizeUri        = require('./uri');
...
},{"./methods":30,"./parameters":31,"./uri":34}],33:[function(require,module,exports){
/**
 * Sanitize resources into nested object form.
 *
...
},{"./context":29,"./helpers":36,"extend":48,"handlebars":37}],36:[function(require,module,exports){
...
},{"camel-case":42,"constant-case":47,"indent-string":57,"lower-case":61,"param-case":68,"pascal-case":70,"snake-case":75,"upper-case":76}],37:[function(require,module,exports){
...
},{"sentence-case":43,"upper-case":76}],43:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":44,"./vendor/non-word-regexp":45,"./vendor/trailing-digit-regexp":46,"lower-case":61}],44:[function(require,module,exports){
...
},{"snake-case":75,"upper-case":76}],48:[function(require,module,exports){
var hasOwn = Object.prototype.hasOwnProperty;
...
},{"handlebars/runtime":55}],57:[function(require,module,exports){
'use strict';
...
},{"repeating":58}],58:[function(require,module,exports){
'use strict';
...
},{"is-finite":59}],59:[function(require,module,exports){
'use strict';
...
},{"http":37}],63:[function(require,module,exports){
/*!
...
},{"./vendor/camel-case-regexp":65,"./vendor/non-word-regexp":66,"./vendor/trailing-digit-regexp":67,"dup":43,"lower-case":61}],65:[function(require,module,exports){
...
},{"upper-case":76}],70:[function(require,module,exports){
...
},{"camel-case":42,"upper-case-first":69}],71:[function(require,module,exports){
arguments[4][43][0].apply(exports,arguments)
},{"./vendor/camel-case-regexp":72,"./vendor/non-word-regexp":73,"./vendor/trailing-digit-regexp":74,"dup":43,"lower-case":61}],72:[function(require,module,exports){
arguments[4][44][0].apply(exports,arguments)

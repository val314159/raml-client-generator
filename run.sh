...
if [ "$2" == "ig" ]; then
  ...
  python -mramyam.gen_client -y data/instagram-api.raml -intermediate >instagram_api.json
...
if [ "$all" == "yes" ]; then
  ...
  python -mramyam.gen_client -y data/bitly-api.raml -intermediate >bitly_api.json
  ...
  python -mramyam.gen_client -y data/box-api.raml -intermediate >box_api.json
  ...
  python -mramyam.gen_client -y data/twilio-rest-api.raml -intermediate >twilio_api.json
  ...
  python -mramyam.gen_client -y data/github-api-v3.raml -intermediate >github_api.json
  ...
  python -mramyam.gen_client -y data/stripe-api.raml -intermediate >stripe_api.json
  ...
  python -mramyam.gen_client -y data/twitter-rest-api.raml -intermediate >twitter_rest_api.json
  ...
  python -mramyam.gen_client -y data/twitter.raml -intermediate >twitter_api.json
